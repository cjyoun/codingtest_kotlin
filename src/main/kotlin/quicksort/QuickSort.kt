...
fun solution(n: Int): String {
    ...
    var num = n     // 받은 정수
    var numList = arrayListOf<Int>()    // 받은 정수를 배열에 나눠 넣기 위한 리스트
...
fun quickMerge(arr: ArrayList<Int>): ArrayList<Int>{
    ...
    var pivot = arr.removeFirst()   // index의 처음 값을 pivot 설정 (비교대상 설정)

    var left = arrayListOf<Int>()   // 왼쪽 리스트
    var right = arrayListOf<Int>()  // 오른쪽 리스트
